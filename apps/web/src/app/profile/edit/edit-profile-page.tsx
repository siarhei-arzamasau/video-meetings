...
import { ArrowLeftIcon, CheckIcon, SignOutIcon, WarningIcon } from '@/components/icons';
 ...
 * is why the shell below owns the gate and each section owns only its own request and state.
 *
...
/**
 * The section's own frame, so `ready` fills it in rather than laying the page out from
 * scratch. The bars are `aria-hidden` and the `output` carries the sentence a screen reader
 * gets.
 */
